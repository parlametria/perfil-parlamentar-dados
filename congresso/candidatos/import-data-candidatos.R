...
import_candidatos <- function(data_path, year) {
  if (year == 2018) {
...
import_candidatos_modelo2010 <- function(data_path){
  ...
  colunas_candidatos <- c("data_geracao", "hora_geracao", "ano_eleicao", "num_turno", "desc_eleicao",  "sigla_UF", 
                          ...
                          "cod_sexo", "desc_sexo", "cod_grau_instrucao", "desc_grau_instrucao", "cod_estado_civil", "desc_estado_civil", 
...
#' @examples
#' candidatos <- import_Candidatos_modelo2010("./candidatos.csv")
import_candidatos_modelo2018 <- function(data_path) {
  library(tidyverse)
  ...
  colunas_candidatos <- c("data_geracao", "hora_geracao", "ano_eleicao", "cod_tipo_eleicao", "desc_tipo_eleicao", "num_turno", 
                          ...
                          "data_nascimento", "idade_cand_data_eleicao", "num_titulo_eleitoral_cand", "cod_sexo", "desc_sexo", 
