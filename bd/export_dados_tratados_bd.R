...
write.csv(comissoes, paste0(output, "comissoes.csv"), row.names = FALSE)
write.csv(composicao_comissoes, paste0(output, "composicao_comissoes.csv"), row.names = FALSE)
write.csv(mandatos, paste0(output, "mandatos.csv"), row.names = FALSE)
write.csv(aderencia, paste0(output, "aderencia.csv"), row.names = FALSE)
message("Concluído")
