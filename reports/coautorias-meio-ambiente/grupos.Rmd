...
Tendo os pares e o peso de suas relações, os grupos foram feitos utilizando uma técnica chamada `agrupamento`, que agrupa os dados de forma automática com base na similaridade entre eles. Para o peso mínimo de 0.1 das relações, foram gerados 7 grupos no total, exibidos abaixo:
