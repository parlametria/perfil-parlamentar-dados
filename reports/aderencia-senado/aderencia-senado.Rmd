...
Alguns partidos possuem aproximadamente metade dos senados com maior aderência: PSDB, PSC, PRB, PDT, MDB e DEM; isso é indicado pela mediana igual a 100%. Os demais partidos. Entre os partidos cujo senadores frequentemente não aderem ao governo estão REDE, PODEMOS e PSL. Os demais partidos possuem aderência com maior variância, mas todos com aderência ainda bem alta, alternando entre 85% a 100% de aderência ao Governo.
