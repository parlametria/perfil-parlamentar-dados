...
Existe 1 proposição que possui votações em plenário cujo tema é classficado como **Meio Ambiente**. A **MPV 867/2018** que prorroga o prazo para adesão de produtores rurais ao Programa de Regularização Ambiental. Essa MPV teve `r votos %>% count(id_votacao) %>% nrow()` votações em plenário.
