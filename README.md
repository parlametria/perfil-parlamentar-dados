...
O **r-updater** é o nosso serviço criado para o fim de obter os dados e atualizá-los no banco de dados do Perfil Parlamentar.
...
| APP_SECRET  | Valor do endpoint para envio das mensagens de log para o bot do Perfil Parlamentar no Telegram |
...
Este serviço executa o crawler que obtem os dados do Perfil Parlamentar de diferentes fontes. Para executá-lo basta:
