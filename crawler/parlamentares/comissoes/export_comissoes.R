...
option_list = list(
  ...
  make_option(c("-ocom", "--outComposicoes"), type="character", default="../../raw_data/composicao_comissoes.csv",
              help="nome do arquivo de saída para as informações de composição de comissões [default= %default]", metavar="character"),
  
  make_option(c("-oc", "--outComissoes"), type="character", default="../../raw_data/comissoes.csv",
